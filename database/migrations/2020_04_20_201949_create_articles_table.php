...
class CreateArticlesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->string('reviewer', 32)->comment('评论者');
            $table->string('title', 100)->comment('标题');
            $table->string('content_short', 100)->comment('内容简介');
            ...
            $table->string('image_uri', 128)->nullable()->comment('图片路径');
            $table->string('platforms', 64)->comment('平台列表');
